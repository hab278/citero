...
//		Citero cit = new Citero(FormatsTest.CSF, Formats.PNX);
...
//		Citero cit = new Citero(FormatsTest.PNX, Formats.PNX);
//		assertEquals(FormatsTest.XERXES_XML, cit.output(Formats.XERXES_XML));
	}
...
//		Citero cit = new Citero(FormatsTest.BIBTEX, Formats.BIBTEX);
//		assertEquals(FormatsTest.XERXES_XML, cit.output(Formats.XERXES_XML));
	}
...
//		Citero cit = new Citero(FormatsTest.RIS, Formats.RIS);
//		assertEquals(FormatsTest.XERXES_XML, cit.output(Formats.XERXES_XML));
	}
...
//		Citero cit = new Citero(FormatsTest.OPENURL, Formats.OPENURL);
//		assertEquals(FormatsTest.XERXES_XML, cit.output(Formats.XERXES_XML));
	}
}