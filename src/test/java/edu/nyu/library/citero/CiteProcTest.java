...
//            System.out.println(res.toString());
            System.out.println(Citero.map(FormatsTest.BIBTEX).from(Formats.BIBTEX).to(Styles.MLA));
            System.out.println(Citero.map(FormatsTest.BIBTEX).from(Formats.BIBTEX).to(Styles.APA));
