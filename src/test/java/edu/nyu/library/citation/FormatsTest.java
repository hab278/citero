...
public class FormatsTest {
	...
	public final static  String RIS_REGEX = "(^[\\w\\d]{1,6}  - [\\w\\W]*$|\\s)+",
			...
			OPENURL = "http://www.oxfordjournals.org/content?genre=article&issn=0013-8266&volume=117&issue=472&atitle=King+Alfred's+Preface+and+the+Teaching+of+Latin+in+Anglo-Saxon+England&sid=Librix:bio&pid=content:fulltext",//"http://resolver.example.edu/cgi?url_ver=Z39.88-2004&rft_val_fmt=info:ofi/fmt:kev:mtx:book&rft.isbn=0836218310&rft.btitle=The+Far+Side+Gallery+3&rft.au=Gary+Larson",
			XERXES_XML = "test",
